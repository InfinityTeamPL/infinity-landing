  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Osoba, która chce się umówić i nie może się dodzwonić, rzadko dzwoni trzeci raz. Otwiera mapę, znajduje kolejny salon i umawia się tam. To strata, której nie widać w kasie ani w kalendarzu — ten termin po prostu nigdy się nie pojawił. Nie da się policzyć wizyt, które nie doszły do skutku, bo aparat zadzwonił w złym momencie.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Przekładanie terminów — dzwoniący podaje datę swojej wizyty, bot znajduje rezerwację i przenosi ją na nowy termin.',
        'Odwoływanie wizyt — także w nocy i w niedzielę, dzięki czemu zwolnione okienko wraca do puli, zamiast zostać puste.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Automatyczne przypomnienie dzień wcześniej działa na dwa sposoby. Po pierwsze, część osób faktycznie zapomina o wizycie i przypomnienie wystarczy. Po drugie — i to jest ważniejsze — osoba, która i tak nie zamierzała przyjść, dostaje wygodny moment, żeby to powiedzieć. Odwołanie na dobę przed terminem to zupełnie inna sytuacja niż puste krzesło o 14:00: zostaje czas, żeby zaproponować termin komuś z listy rezerwowej.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Poza samym połączeniem technicznym trzeba spisać reguły salonu: ile trwa która usługa, którzy pracownicy ją wykonują, jakie przerwy muszą zostać między zabiegami, czy koloryzacja wymaga wcześniejszego testu, do kiedy można odwołać bez konsekwencji. Bot jest tak dobry, jak te ustalenia — dlatego robimy je z osobą, która na co dzień układa grafik, a nie na podstawie ogólnego szablonu.',
        'Dane osób dzwoniących — imię, numer telefonu, historia wizyt, nagrania rozmów — trzymamy na serwerach w Polsce, zgodnie z RODO, według standardów zgodnych z ISO 27001. Z salonem podpisujemy umowę powierzenia przetwarzania danych i ustalamy, jak długo przechowujemy nagrania.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Nie ma też sensu, gdy większość klientów już rezerwuje przez internet i telefon jest kanałem marginalnym. Wtedy problemem nie jest odbieranie połączeń, tylko coś innego — i lepiej to najpierw nazwać, zanim dołożycie kolejne narzędzie.',
