  ...
  sections: [
    {
      ...
      paragraphs: [
        'Większość infolinii przewoźnikowych działa w jednym z dwóch trybów. Albo telefon odbiera człowiek — w godzinach pracy biura, jeden dzwoniący naraz, reszta słucha sygnału zajętości. Albo stoi automat IVR: „wybierz jeden, aby usłyszeć rozkład jazdy", a potem drzewko menu, w którym rozkładu i tak nie ma, bo nagrania nikt nie aktualizował od zeszłego sezonu.',
        'Agent głosowy w transporcie działa inaczej, bo nie odtwarza nagrań, tylko rozumie pytanie i sprawdza odpowiedź w danych. Pasażer mówi „o której jest najbliższy autobus z Gryfic do Trzebiatowa", a bot odpowiada konkretną godziną. Nie trzeba znać numeru linii, nie trzeba wybierać cyfr, nie trzeba dzwonić w godzinach pracy biura.',
        'Druga różnica to skala. Kiedy w poniedziałek rano po zmianie rozkładu dzwoni sto osób naraz, człowiek odbierze jedną rozmowę, a bot sto. Głos oparty na technologii ElevenLabs brzmi po polsku naturalnie — z odmianą nazw miejscowości i normalną intonacją, a nie sylabizowaniem znanym ze starych syntezatorów.',
      ],
    },
    {
      heading: 'Co agent głosowy załatwia na infolinii przewoźnika',
      paragraphs: [
        'Zakres ustalamy przed wdrożeniem, bo zależy od tego, jakie dane firma faktycznie udostępnia i do jakich systemów da się podłączyć. Poniżej to, co realnie da się obsłużyć głosem — bez obiecywania integracji, których jeszcze nie widzieliśmy.',
      ],
      bullets: [
        ...
        'Przyjmowanie reklamacji i zgłoszeń — spisuje treść, dane kontaktowe i numer kursu, a potem przekazuje zgłoszenie do systemu obsługi klienta w uzgodnionym formacie.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Drugi przypadek: rozkład, którego nie ma w żadnej ustrukturyzowanej formie. Jeżeli aktualne godziny istnieją wyłącznie jako skan PDF wieszany na przystanku i zmieniany ręcznie co miesiąc, najpierw trzeba uporządkować dane. Bot nie naprawi bałaganu w źródle — powieli go, tylko szybciej i przez telefon.',
        'Trzeci przypadek: gdy większość rozmów to nietypowe sprawy wymagające decyzji. Przewóz ładunku specjalnego, negocjacja stawki, reklamacja szkody transportowej — to rozmowy, w których pasażer albo kontrahent i tak trafi do człowieka. Wtedy voicebot ma sens najwyżej jako pierwsza warstwa: odbiera, kwalifikuje sprawę i przekazuje ją dalej wraz z notatką. Bywa, że i to wystarczy, żeby wdrożenie się opłaciło, ale liczby trzeba policzyć przed startem, a nie po.',
      ],
    },
    {
      heading: 'Dane, RODO i nagrania rozmów',
      paragraphs: [
        'Na infolinii przewoźnika padają dane osobowe: imię i nazwisko przy reklamacji, numer telefonu, czasem numer biletu i relacja przejazdu. Wszystko, co przetwarza voicebot — nagrania, transkrypcje, dane kontaktowe — trzymamy na serwerach w Polsce, zgodnie z RODO i według standardów zgodnych z ISO 27001.',
  ...
  howTo: {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'Piszemy przebieg typowych rozmów: pytanie o odjazd, o status kursu, o bilet, zgłoszenie reklamacji. Ustalamy też twarde granice — czego bot nie mówi i w jakich sytuacjach od razu przełącza do dyspozytora.',
      },
      {
