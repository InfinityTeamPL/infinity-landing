...
const content: SeoLandingContent = {
  ...
  lead: 'Automatyzacja procesów AI to zastąpienie powtarzalnej pracy biurowej agentami, którzy samodzielnie wykonują zadania: czytają dokumenty, piszą e-maile, uzupełniają systemy i pilnują terminów. W przeciwieństwie do chatbota agent nie tylko odpowiada na pytania — realizuje cały proces od początku do końca, a człowiek zatwierdza wynik.',
  ...
  sections: [
    {
      heading: 'Agenci AI dla firm — czym różnią się od chatbotów',
      paragraphs: [
        'Większość firm zna AI od strony chatbotów: narzędzi, które odpowiadają na pytania. Agent AI idzie o krok dalej — dostaje zadanie i je wykonuje. Odbiera e-mail z zamówieniem, wyciąga z niego dane, wprowadza je do systemu, przygotowuje potwierdzenie i zapisuje sprawę w CRM. Tam, gdzie chatbot kończy na rozmowie, agent kończy na rezultacie.',
        'Nasze wdrożenia budujemy m.in. na OpenClaw — frameworku agentów AI, który w 60 dni od premiery stał się najpopularniejszym projektem na GitHubie i ma dziś ponad 380 tysięcy gwiazdek. Stworzył go Peter Steinberger, a my wykorzystujemy go do łączenia agentów z narzędziami, z których Twoja firma już korzysta: pocztą, kalendarzem, CRM-em czy systemem księgowym.',
        'Jako agencja automatyzacji AI nie sprzedajemy gotowego pudełka. Każde wdrożenie zaczynamy od procesów, które faktycznie zabierają czas Twojemu zespołowi — i dopiero pod nie dobieramy narzędzia oraz zakres samodzielności agenta.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Procesy kreatywne, negocjacje i decyzje strategiczne zostawiamy ludziom. Automatyzacja AI dla firm działa najlepiej tam, gdzie praca jest przewidywalna, a ewentualny błąd łatwo wychwycić — dlatego na audycie wskazujemy najpierw zadania o niskim ryzyku i szybkim zwrocie z inwestycji.',
      ],
      bullets: [
        'Powtarzalne — wykonywane codziennie lub co tydzień według tego samego schematu, np. przepisywanie danych z faktur czy przygotowywanie zestawień.',
        'Regułowe — da się je opisać jasnymi zasadami: jeśli X, zrób Y. Agent potrzebuje reguł, nie intuicji.',
        'Wysokowolumenowe — im więcej powtórzeń, tym szybciej zwraca się wdrożenie; sto e-maili dziennie to lepszy kandydat niż jeden tygodniowo.',
      ],
    },
    {
      heading: 'Człowiek w pętli — automatyzacja pod kontrolą',
      paragraphs: [
        'W procesach, które dotykają pieniędzy, klientów albo danych osobowych, agent nie działa w pełni samodzielnie. Stosujemy podejście human-in-the-loop: agent przygotowuje pracę — projekt odpowiedzi, wypełniony dokument, zestawienie do akceptacji — a człowiek zatwierdza wynik jednym kliknięciem. Zespół zachowuje kontrolę, ale przestaje wykonywać pracę odtwórczą.',
        'Zakres samodzielności agenta ustalamy wspólnie na etapie wdrożenia i możemy go stopniowo rozszerzać. Zwykle firmy zaczynają od akceptacji każdego kroku, a po kilku tygodniach zostawiają sobie tylko wyjątki i sprawy nietypowe.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Dla sektora rolniczego stworzyliśmy aplikację AI wspierającą codzienne decyzje operacyjne, a dla regionalnego przewoźnika autobusowego — agenta głosowego, który przez telefon podaje rozkłady jazdy 24/7. Zbudowaliśmy też platformę kojarzącą startupy z inwestorami. Różne branże, ten sam schemat: powtarzalny proces przejmuje agent, człowiek pilnuje jakości.',
      ],
    },
  ],
  howTo: {
    ...
    steps: [
      {
        name: 'Audyt procesów',
        text: 'Na bezpłatnej konsultacji mapujemy procesy w Twojej firmie i sprawdzamy, ile czasu pochłaniają. Szukamy zadań powtarzalnych, regułowych i wysokowolumenowych.',
      },
      {
  ...
  useCases: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Wystawianie faktur cyklicznych, dopasowywanie płatności do dokumentów i przypomnienia o zaległościach — z akceptacją człowieka.',
      },
      {
        title: 'Onboarding',
        description:
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Małe wdrożenia — jeden proces, kilka integracji — zamykamy w 2–4 tygodnie. Większe projekty, obejmujące kilka działów i systemów, trwają zwykle 1–3 miesiące. Zawsze zaczynamy od pilota, więc pierwsze efekty widzisz na długo przed końcem całego projektu.',
    },
  ],
  cta: {
