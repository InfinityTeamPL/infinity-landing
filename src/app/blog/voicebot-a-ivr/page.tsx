...
const content: BlogArticleContent = {
  ...
  sections: [
    ...
    {
      heading: 'Jak działa voicebot — swobodna mowa zamiast wybierania tonowego',
      paragraphs: [
        ...
        'Najważniejsza różnica jest jednak głębiej. Agent nie tylko rozumie — ma dostęp do danych i może w trakcie rozmowy coś zrobić. Sprawdzić rozkład, kalendarz, status zamówienia, wolne terminy. Dopytać o brakującą informację, jeśli dzwoniący podał za mało. Zapisać wizytę, wysłać SMS z potwierdzeniem, zanotować zgłoszenie. Rozmowa i akcja dzieją się w tym samym czasie, więc nie kończy się zdaniem „proszę zadzwonić w godzinach pracy biura".',
    ...
    {
      heading: 'Voicebot a IVR — porównanie punkt po punkcie',
      paragraphs: [
        'Zestawmy oba rozwiązania w kategoriach, które faktycznie decydują o wyborze. Nie w tabelce z gwiazdkami, tylko w tym, co dzwoniący odczuwa w pierwszych trzydziestu sekundach.',
      ],
      bullets: [
        ...
        'Akcja w trakcie rozmowy — IVR: przekierowuje i na tym kończy rolę. Voicebot: rezerwuje termin, zmienia rezerwację, wysyła potwierdzenie, rejestruje zgłoszenie — jeszcze zanim rozmowa się skończy.',
    ...
    {
      heading: 'IVR czy voicebot — czy trzeba wyrzucać to, co już macie',
      paragraphs: [
        ...
        'Wariant pierwszy: agent staje przed IVR. Odbiera połączenie, pyta o sprawę, rozumie odpowiedź i albo załatwia ją sam, albo przekierowuje dokładnie tam, gdzie trzeba — omijając trzy poziomy menu. Dzwoniący w ogóle nie słyszy drzewka, a firma zachowuje dotychczasową strukturę działów pod spodem.',
    ...
    {
      heading: 'Nowoczesna infolinia w praktyce — nasze demo transportowe',
      paragraphs: [
        ...
        'Demo pokrywa 6 przystanków i 276 odjazdów. Można zadzwonić i zapytać zwyczajnie, o której jest najbliższy autobus w konkretną stronę, a agent odpowie konkretną godziną i poda źródło, z którego wziął dane. To ostatnie jest w tym wszystkim najważniejsze: agent nie zgaduje i nie improwizuje rozkładu, tylko cytuje to, co ma w danych. W klasycznym IVR taka rozmowa jest technicznie niewykonalna — nie da się wystukać cyfrą pytania „o której mam autobus z centrum do szpitala w sobotę rano".',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Druga sytuacja: brak danych, na których agent miałby pracować. Jeśli terminy są w zeszycie, ceny w głowie właściciela, a status zlecenia zna tylko brygadzista, agent nie ma skąd wziąć odpowiedzi. Wtedy pierwszym krokiem nie jest AI, tylko uporządkowanie informacji — i mówimy to firmom regularnie, nawet gdy oznacza to przesunięcie projektu o kilka miesięcy.',
        'Trzecia: rozmowy, w których stawką jest decyzja, negocjacja albo emocje. Reklamacja z awanturą, sprzedaż wymagająca wyczucia, sprawa wrażliwa. Tu agent może najwyżej odebrać, zebrać podstawowe informacje i szybko przełączyć do człowieka. Jeśli takie rozmowy stanowią większość Waszego ruchu, sensowniejszą inwestycją jest szkolenie zespołu, a nie automatyzacja pierwszej linii.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Najpierw dopytuje, tak jak zrobiłby człowiek, i prosi o powtórzenie albo doprecyzowanie. Jeśli po drugiej próbie dalej nie ma pewności, przekazuje rozmowę do pracownika razem z podsumowaniem tego, co już padło. Ustalamy też twarde reguły: przy określonych słowach albo typach spraw agent przełącza od razu, bez prób samodzielnego załatwienia.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Wdrożenie zaczyna się od 5 000 zł netto, a większe projekty wyceniamy indywidualnie po rozpoznaniu zakresu. Do tego dochodzi utrzymanie: 249, 499 albo 799 zł netto miesięcznie w zależności od pakietu. Pierwsza konsultacja jest bezpłatna i często kończy się wnioskiem, że wystarczy uruchomić agenta na jednym fragmencie ruchu.',
    },
  ],
  related: [
