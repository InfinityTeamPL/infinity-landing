...
const content: BlogArticleContent = {
  ...
  sections: [
    {
      paragraphs: [
        'Pytanie „agent AI czy pracownik" pada na co drugim spotkaniu i prawie zawsze jest źle postawione. Brzmi jak wybór między dwoma zamiennikami, jakby chodziło o to, czy kupić samochód spalinowy, czy elektryczny. A to nie są zamienniki. Agent AI nie jest tańszą wersją człowieka, tylko innym rodzajem narzędzia — takim, które robi dobrze jedną wąską rzecz i nie robi wcale całej reszty.',
    ...
    },
    {
      ...
      paragraphs: [
        'Pierwszy błąd w takich kalkulacjach to porównywanie miesięcznego abonamentu za oprogramowanie z wynagrodzeniem netto pracownika. To dwie różne wielkości. Realny koszt zatrudnienia to co najmniej sześć składników i tylko jeden z nich widać na pasku wypłaty.',
        'Do wynagrodzenia brutto dochodzą składki po stronie pracodawcy. Dochodzi urlop i zwolnienia lekarskie, czyli miesiące, za które płacicie, a praca się nie dzieje albo przechodzi na kogoś innego. Dochodzi rekrutacja: ogłoszenia, czas osoby, która prowadzi rozmowy, czasem prowizja agencji. Dochodzi wdrożenie — kilka pierwszych tygodni, w których nowa osoba pracuje wolniej, a ktoś doświadczony traci swój czas na tłumaczenie. Dochodzi stanowisko pracy: sprzęt, licencje, telefon, biurko. I dochodzi rotacja, najbardziej podstępna pozycja: jeśli ktoś odchodzi po roku, cały koszt rekrutacji i wdrożenia ponosicie od nowa.',
        'Nie podamy tu przykładowych kwot, bo byłyby zmyślone — różnice między stanowiskami, miastami i branżami są zbyt duże, żeby jedna liczba miała sens. Zamiast tego policzcie swoje. Do tego zrobiliśmy kalkulator ROI: wpisujecie liczbę godzin poświęcanych dziś na powtarzalne czynności i swoje realne stawki, a on pokazuje, o jakiej skali mówimy. To zajmuje kilka minut i jest znacznie uczciwsze niż jakikolwiek benchmark z internetu.',
        'Warto też policzyć drugą stronę bilansu: koszt tego, że czegoś nie robicie. Nieodebrany telefon o osiemnastej to nie jest zero złotych. To jest zapytanie, które poszło do konkurencji. Ta pozycja rzadko trafia do zestawień, bo nie ma jej w żadnym systemie księgowym, a często jest największa.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'To jest część, którą większość ofert pomija, a która decyduje o tym, czy wdrożenie się uda. Agent AI ma twarde granice i lepiej je znać przed podpisaniem umowy niż po.',
        ...
        'Nie zbuduje relacji. Klient, który dzwoni, bo lubi rozmawiać z panią Anią z biura, dzwoni po coś, czego agent nie dostarczy. W części branż to jest cała przewaga firmy i automatyzowanie tego byłoby strzałem w kolano. Nie wymyśli też nowego rozwiązania — działa w ramach tego, co wie, i nie zaproponuje procesu, którego nikt wcześniej nie opisał.',
    ...
    {
      heading: 'Realny scenariusz — agent bierze powtarzalne, człowiek trudne',
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Druga: praca, której nikt nie potrafi opisać. Jeśli na pytanie „jak wygląda ten proces" pada odpowiedź „to zależy, Kasia wie", agent nie ma z czego się uczyć. Automatyzacja wymaga, żeby ktoś najpierw ubrał wiedzę w słowa i zasady. Czasem to jest właśnie wartościowa część projektu, ale trzeba na nią zarezerwować czas i uczciwie powiedzieć, że to nie jest praca za darmo.',
        'Trzecia: procesy oparte na zaufaniu i obecności. Sprzedaż wymagająca wyczucia, opieka nad kluczowym klientem, sprawy wrażliwe, negocjacje. Tu automatyzacja pierwszej linii może wręcz zaszkodzić, bo klient odbierze ją jako sygnał, że przestał być ważny.',
