...
const content: BlogArticleContent = {
  ...
  sections: [
    {
      paragraphs: [
        'Pytanie „ile kosztuje voicebot" pada zwykle w pierwszych trzech minutach rozmowy — czasem zanim jeszcze ustalimy, co ten voicebot miałby właściwie robić. To zrozumiałe. Zanim ktokolwiek zacznie się zastanawiać nad scenariuszami rozmów, chce wiedzieć, czy w ogóle mieści się w budżecie.',
        'Problem polega na tym, że uczciwa odpowiedź brzmi „zależy", a to nikomu nie pomaga. Więc rozbijemy tę cenę na części. Cena voicebota to nie jedna liczba, tylko trzy osobne strumienie: jednorazowe wdrożenie, miesięczne utrzymanie oraz koszty zmienne — telefonia i czas rozmów. Ten trzeci strumień najczęściej znika z ofert konkurencji, a potrafi zaskoczyć po pierwszym pełnym miesiącu pracy agenta.',
        'Poniżej pokazujemy nasze widełki wprost, tłumaczymy, co je przesuwa w górę, i — co ważniejsze — piszemy, kiedy koszt agenta głosowego się nie zwróci. Bo nie zawsze się zwraca, a lepiej usłyszeć to przed wdrożeniem niż po nim.',
      ],
    },
    {
      ...
      bullets: [
        'Wdrożenie — jednorazowo. Rozpisanie scenariuszy rozmowy, zbudowanie bazy wiedzy, konfiguracja i strojenie głosu, podpięcie agenta pod telefonię, testy na realnych połączeniach i szkolenie zespołu. To największa pozycja na starcie.',
        'Utrzymanie — co miesiąc. Monitoring działania, poprawki scenariuszy po pierwszych tygodniach ruchu, aktualizacja bazy wiedzy, gdy zmienia się oferta lub cennik, reakcja na zgłoszenia.',
        'Telefonia i minuty rozmów — zmiennie, zależnie od ruchu. Numer telefoniczny, abonament u operatora oraz przetwarzanie rozmowy rozliczane za czas jej trwania. Ta pozycja jest po stronie klienta i wracamy do niej za chwilę osobno.',
        'Integracje — zależnie od zakresu. Kalendarz, system rezerwacji, CRM, baza zamówień, przekazanie rozmowy do konkretnego pracownika. Każdy system, do którego agent ma sięgnąć, to osobna praca i osobne testy.',
      ],
    },
    {
      heading: 'Telefonia i minuty rozmów — koszt po stronie klienta',
      paragraphs: [
        'To jest ta część, o której chcemy napisać najbardziej wprost, bo najczęściej bywa przemilczana. Agent głosowy musi mieć numer, pod który dzwonią klienci, i łącze, przez które te połączenia przechodzą. Numer i minuty kupujesz u operatora telefonii — nie u nas. My możemy pomóc wybrać operatora i wszystko podpiąć, ale rachunek za połączenia przychodzi od niego i to on ustala stawki.',
        'Rekomendujemy zwykle, żeby konto u operatora było założone na Waszą firmę. Dzięki temu widzicie rachunek co do minuty, możecie w każdej chwili zmienić dostawcę i nie płacicie nikomu marży za pośrednictwo w odsprzedaży minut. Wadą jest jedna faktura więcej w księgowości. Zaletą — pełna kontrola nad kosztem, który rośnie razem z liczbą rozmów.',
        'Do minut telefonicznych dochodzi drugi koszt liczony od czasu rozmowy: przetwarzanie mowy i praca modelu językowego. Krótka, konkretna rozmowa kosztuje ułamek tego, co pięciominutowa dyskusja. Nie podajemy tu stawek za minutę, bo zależą od dostawcy, wolumenu i tego, jak długie są rozmowy w Waszej branży — a wpisana na sztywno liczba zestarzałaby się szybciej niż ten artykuł. Podajemy je zawsze w wycenie, razem z symulacją miesięcznego rachunku przy Waszym realnym ruchu.',
        'Praktyczny wniosek: przy voicebocie liczy się nie tylko liczba połączeń, ale też ich długość. Agent, który w trzydzieści sekund poda godzinę odjazdu, jest tani w utrzymaniu. Agent prowadzący czterominutową rozmowę kwalifikacyjną z każdym leadem — znacznie droższy, choć nadal zwykle tańszy niż etat.',
      ],
    },
    {
      heading: 'Ile kosztuje agent głosowy u nas — widełki wprost',
      paragraphs: [
        ...
        'Czas realizacji: mniejsze wdrożenie zamykamy w 2–4 tygodnie, większe w 1–3 miesiące. Pierwsza konsultacja i audyt procesów są bezpłatne i to na nich pada konkretna kwota — nie przed nimi. Wszystkie podane ceny są cenami netto i nie obejmują opisanego wyżej rachunku od operatora telefonii.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Integracje — połączenie z kalendarzem, systemem rezerwacji, CRM-em czy bazą zamówień. Im starszy i mniej otwarty system, tym więcej pracy. Zdarza się, że integracja kosztuje więcej niż sam agent, bo trzeba obejść brak sensownego API.',
    ...
    },
    {
      ...
      paragraphs: [
        'Teraz część, której nie znajdziecie w typowej ofercie. Voicebot bywa złą inwestycją i lepiej to wiedzieć na etapie konsultacji, kiedy kosztuje to tylko godzinę rozmowy.',
