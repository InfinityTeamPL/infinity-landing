...
// Tło: ta sama siatka CSS co w reszcie serwisu (wcześniej shader WebGL — ~150 kB three.js
// na stronie prawnej to zły kompromis; siatka jest lżejsza i spójna z rebrandem)
