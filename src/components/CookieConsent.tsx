...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] p-4 md:p-6">
      {/* dark = dotychczasowy wygląd (default), light = biała karta hairline */}
      <style dangerouslySetInnerHTML={{ __html: `
        .cc-card {
          background: var(--surface-1);
        }
        [data-theme="light"] .cc-card.cc-card {
          background: #ffffff;
          border-color: var(--border-soft);
          box-shadow: var(--shadow-card-hover);
        }
      ` }} />
      <div className="cc-card max-w-4xl mx-auto backdrop-blur-md border border-[#2E4AAD]/40 rounded-2xl p-5 md:p-6 shadow-2xl shadow-black/40">
